...
const fetchProject = async () => {
  try {
    const response = await api.get(`/api/v1/projects/${projectId.value}`)
    formData.value = {
...
const submitForm = async () => {
  ...
  try {
    ...
    await api.put(`/api/v1/projects/${projectId.value}`, formData.value)
  ...
  <div class="edit-project-container">
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <button class="apple-button apple-button-secondary" @click="cancelEdit">
        ...
        >
          ...
          <div class="form-actions">
            ...
            <button 
              ...
              :disabled="loading"
            >
              <el-icon v-if="!loading"><Edit /></el-icon>
              {{ loading ? '更新中...' : '更新项目' }}
            </button>
          </div>
        </el-form>
